...
>           foldBinOp f [x] = x
>           foldBinOp f (x:xs) = f x (foldBinOp f xs)

TODO: add simplifying
maxima doesn't have Divide, Minus, Sqrt, ...
Plus (Multiply (Integer -1) a) b -> Minus b a
Plus a (Multiply (Integer -1) b) -> Minus a b
Multiply (Expt a (Integer -1)) b -> Divide b a
Multiply a (Expt b (Integer -1)) -> Divide a b
Expt a (Rational 1%2)            -> Sqrt a
...
...
substitute :: Map String CASExpr -> CASExpr -> CASExpr
